import json, time, decimal, base64, sys
...
def key_path(key_name):
    #  so tests don't crash finding files
    return key_name
...
class TestJWT:
    ...
    def test_decodes_complete_valid_jwt(self):
        example_payload = {"hello": "world"}
        example_secret = "secret"
        example_jwt = (
            b"eyJhbGciOiAiSFMyNTYiLCAidHlwIjogIkpXVCJ9"
    ...
    def test_encode_with_non_str_iss(self):
    ...
    def test_decode_raises_exception_if_iat_is_greater_than_now(self, payload):
    ...
    def test_decode_works_if_iat_is_str_of_a_number(self, payload):
    ...
    def test_decode_allows_aud_to_be_none(self):
    ...
    # to still pass).
    # def test_decodes_valid_es256_jwt(self):
    #     example_payload = {"hello": "world"}
    ...
    def test_decode_with_expiration(self, payload):
    ...
    def test_decode_with_notbefore(self, payload):
    ...
    def test_decode_skip_expiration_verification(self, payload):
    ...
    def test_decode_skip_notbefore_verification(self, payload):
    ...
    def test_decode_with_expiration_with_leeway(self, payload):
    ...
    def test_decode_with_notbefore_with_leeway(self, payload):
        payload["nbf"] = utc_timestamp() + 10
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_check_audience_list_when_valid(self):
        payload = {"some": "payload", "aud": "urn:me"}
        token = jwt.encode(payload, "secret")
        jwt.decode(
            token,
    ...
    def test_check_audience_none_specified(self):
        payload = {"some": "payload", "aud": "urn:me"}
        token = jwt.encode(payload, "secret")
        with pytest.raises(InvalidAudienceError):
            jwt.decode(token, "secret", algorithms=["HS256"])

    def test_raise_exception_invalid_audience_list(self):
        payload = {"some": "payload", "aud": "urn:me"}
        token = jwt.encode(payload, "secret")
        with pytest.raises(InvalidAudienceError):
            jwt.decode(
    ...
    def test_raise_exception_audience_as_bytes(self):
        payload = {"some": "payload", "aud": ["urn:me", "urn:someone-else"]}
        token = jwt.encode(payload, "secret")
        with pytest.raises(InvalidAudienceError):
    ...
    def test_rasise_exception_on_partial_issuer_match(self):
        issuer = "urn:expected"
    ...
    def test_check_issuer_list_when_valid(self):
    ...
    def test_raise_exception_invalid_issuer_list(self):
    ...
    def test_decode_should_raise_error_if_exp_required_but_not_present(self):
        payload = {
            "some": "payload",
            # exp not present
        }
    ...
    def test_decode_should_raise_error_if_iat_required_but_not_present(self):
        payload = {
            "some": "payload",
            # iat not present
        }
    ...
    def test_decode_should_raise_error_if_nbf_required_but_not_present(self):
        payload = {
            "some": "payload",
            # nbf not present
        }
    ...
    def test_decode_with_verify_exp_option(self, payload):
        payload["exp"] = utc_timestamp() - 1
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_with_verify_exp_option_and_signature_off(self, payload):
        payload["exp"] = utc_timestamp() - 1
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_with_optional_algorithms(self, payload):
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_no_algorithms_verify_signature_false(self, payload):
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)

        jwt.decode(jwt_message, secret, options={"verify_signature": False})

    def test_decode_legacy_verify_warning(self, payload):
        secret = "secret"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_no_options_mutation(self, payload):
    ...
    # def test_decode_warns_on_unsupported_kwarg(self, payload):
    #     secret = "secret"
    #     jwt_message = jwt.encode(payload, secret)
    ...
    # def test_decode_complete_warns_on_unsupported_kwarg(self, payload):
    #     secret = "secret"
    #     jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_strict_aud_forbids_list_audience(self, payload):
        secret = "secret"
        payload["aud"] = "urn:foo"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_strict_aud_forbids_list_claim(self, payload):
        secret = "secret"
    ...
    def test_decode_strict_aud_does_not_match(self, payload):
        secret = "secret"
        payload["aud"] = "urn:foo"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_decode_strict_ok(self, payload):
        secret = "secret"
        payload["aud"] = "urn:foo"
        jwt_message = jwt.encode(payload, secret)
    ...
    def test_encode_decode_sub_claim(self):
        payload = {
            "sub": "user123",
        }
    ...
    def test_decode_without_and_not_required_sub_claim(self):
        secret = "your-256-bit-secret"
    ...
    def test_decode_missing_sub_but_required_claim(self):
        secret = "your-256-bit-secret"
        token = jwt.encode({}, secret, algorithm="HS256")
    ...
    def test_decode_invalid_int_sub_claim(self):
        payload = {
            "sub": 1224344,
        }
        secret = "your-256-bit-secret"
    ...
    def test_decode_with_valid_sub_claim(self):
        payload = {
            "sub": "user123",
        }
        secret = "your-256-bit-secret"
    ...
    def test_decode_with_invalid_sub_claim(self):
        payload = {
            "sub": "user123",
        }
        secret = "your-256-bit-secret"
    ...
    def test_decode_with_sub_claim_and_none_subject(self):
        payload = {
            "sub": "user789",
        }
        secret = "your-256-bit-secret"
    ...
    def test_encode_decode_with_valid_jti_claim(self):
        payload = {
            "jti": "unique-id-456",
        }
        secret = "your-256-bit-secret"
    ...
    def test_decode_missing_jti_when_required_claim(self):
    ...
    def test_decode_missing_jti_claim(self):
        secret = "your-256-bit-secret"
        token = jwt.encode({}, secret, algorithm="HS256")
    ...
    def test_jti_claim_with_invalid_int_value(self):
        special_jti = 12223
        payload = {
            "jti": special_jti,
        }
    ...
    def test_validate_iss_with_container_of_str(self) -> None:
    ...
    def test_validate_iss_with_non_str(self):
    ...
    def test_validate_iss_with_non_str_issuer(self):
        """Regression test for #1039"""
        payload = {
            "iss": "123",
        }
